...
import math
import helm
carCascade = cv2.CascadeClassifier('/Downloads/Automated-Traffic-Rule-Violation-Detection-System/dev/ML/haarcascades/cars.xml')
bikeCascade = cv2.CascadeClassifier('/Downloads/Automated-Traffic-Rule-Violation-Detection-System/dev/ML/haarcascades/motor-v4.xml')
video = cv2.VideoCapture('/Downloads/Automated-Traffic-Rule-Violation-Detection-System/dev/ML/input/helm1.mp4')
